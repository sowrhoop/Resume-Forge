...
It comes packed with features such as real-time editing, dozens of templates, drag-and-drop customisation, and optional OpenAI-assisted writing tools.

You can share a personalised link of your resume to potential employers and customise your page layout by dragging-and-dropping sections. The platform also supports various font options and provides dozens of templates to choose from. And yes, there's even a dark mode for a more comfortable viewing experience.
...
- **Bring your own OpenAI API key** and unlock writing helpers such as tone changes or grammar touch-ups in one-click
...
- Built with dependable technologies that are battle tested and peer reviewed by the open-source community on GitHub
