    ...
    <section id="css" className="grid gap-y-6">
      ...
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-x-4">
          <SectionIcon id="css" size={18} name={`Custom CSS`} />
          <h2 className="line-clamp-1 text-2xl font-bold lg:text-3xl">{`Custom CSS`}</h2>
        </div>
      </header>
      ...
      <main className="space-y-4">
        <div className="flex items-center gap-x-4">
          ...
          />
          <Label htmlFor="metadata.css.visible">{`Apply Custom CSS`}</Label>
        </div>
