    ...
    <section id="export" className="grid gap-y-6">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-x-4">
          <SectionIcon id="export" size={18} name={`Export`} />
          <h2 className="line-clamp-1 text-2xl font-bold lg:text-3xl">{`Export`}</h2>
        </div>
      </header>
        ...
        >
          ...
          <CardContent className="flex-1">
            ...
            <CardDescription className="font-normal">
              {`Download a JSON snapshot of your resume. This file can be used to import your resume in the future, or can even be shared with others to collaborate.`}
            </CardDescription>
          </CardContent>
        </Card>
