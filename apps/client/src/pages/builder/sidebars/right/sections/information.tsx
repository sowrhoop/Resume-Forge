  ...
  <Card className="space-y-4 bg-info text-info-foreground">
    ...
    <CardFooter>
      ...
      >
        ...
        <span className="line-clamp-1">{`Donate to Reactive Resume`}</span>
      </a>
    </CardFooter>
  </Card>
);
  ...
  <Card className="space-y-4">
    ...
    <CardFooter className="space-x-4">
      ...
      >
        ...
        <span className="line-clamp-1">{`Raise an issue`}</span>
      </a>
      ...
      <a className={cn(buttonVariants({ size: "sm" }))} href="mailto:hello@amruthpillai.com">
        ...
        <span className="line-clamp-1">{`Send me a message`}</span>
      </a>
    </CardFooter>
  </Card>
);
  ...
  <Card className="space-y-4">
    ...
    <CardFooter className="space-x-4">
      ...
      >
        ...
        <span className="line-clamp-1">{`Documentation`}</span>
      </a>
    </CardFooter>
  </Card>
);
    ...
    <section id="information" className="grid gap-y-6">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-x-4">
          <SectionIcon id="information" size={18} name={`Information`} />
          <h2 className="line-clamp-1 text-2xl font-bold lg:text-3xl">{`Information`}</h2>
        </div>
      </header>
